...
@PropertySource("classpath:com/drivojoy/config/production/db-config.properties")
@Profile({"production","debug"})
@EnableAsync
@EnableScheduling
@EnableAspectJAutoProxy
public class InventoryDatabaseProductionConfig implements AsyncConfigurer, SchedulingConfigurer {

	private static final Logger logger = LoggerFactory.getLogger(InventoryDatabaseProductionConfig.class);
