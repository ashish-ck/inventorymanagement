...
@PropertySource("classpath:com/drivojoy/config/test/db-config.properties")
@Profile("test")
@EnableAsync
@EnableScheduling
@EnableAspectJAutoProxy
public class InventoryDatabaseTestConfig implements AsyncConfigurer, SchedulingConfigurer {

	private static final Logger logger = LoggerFactory.getLogger(InventoryDatabaseTestConfig.class);
	...
	public DataSource dataSource(){
		...
		dataSource.setUrl("jdbc:mysql://localhost:3306/drivojoy_inventory_test"); 
